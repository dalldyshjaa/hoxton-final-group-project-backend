/*
  ...
  - Added the required column `image` to the `Favorites` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Favorites" ("id", "roomId", "title", "userId") SELECT "id", "roomId", "title", "userId" FROM "Favorites";
